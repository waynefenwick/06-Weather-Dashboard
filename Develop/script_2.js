...
window.addEventListener('load', function() {
     ...
     cityInterest.textContent = savedCity;
     }
});
...
srchCityOfInterest.addEventListener('click', // On click, the function starts
     function(event) {
     event.preventDefault(); // 1st step in the function is to prevent the page reset default
     const city = srchCityOfInterest.value // the name of the city you typed in now = city...city is now in api 
...
// Step Save city to local storage
